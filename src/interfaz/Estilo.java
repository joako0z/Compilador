...
public class Estilo extends DefaultStyledDocument {
    ...
    public Estilo() {
       ...
       // StyleConstants.setBold(comment, false);
        ...
        //StyleConstants.setForeground(keyword, new Color(84, 180, 115));
        StyleConstants.setBold(keyword, false);

        quote = new SimpleAttributeSet();
        StyleConstants.setForeground(quote, Color.CYAN);
        ...
        //StyleConstants.setForeground(operator, new Color(186, 15, 23));
        ...
        //StyleConstants.setForeground(number, Color.DARK_GRAY);

        special = new SimpleAttributeSet();
        StyleConstants.setForeground(special, Color.cyan);
        ...
        //this.getDocumentProperties().put(PlainDocument.tabSizeAttribute, 4);
    ...
    public void insertString(int offset, String str, AttributeSet a) throws BadLocationException {
        /*if (str.equals("{") || str.equals("(") || str.equals("["))
         str = addMatchingBrace(offset,str);*/
    ...
    private int getOtherToken(String content, int startOffset, int endOffset) {
        ...
        while (endOfToken <= endOffset) {
            if (isDelimiter(content.substring(endOfToken, endOfToken + 1), endOfToken)) {
                break;
            }
     ...
     */
    protected boolean isDelimiter(String character, int start) {
        String operands = ";:{}()[]+-/%<=>!&|^~*,";
        //String operands = ";:{}()[]^~";
        ...
        if (Character.isWhitespace(character.charAt(0))
            ...
            if (isOperator(character)) {
                doc.setCharacterAttributes(start, 1, operator, false);
            }
            if (isSpecial(character)) {
                doc.setCharacterAttributes(start, 1, special, false);
            }
            return true;
        } else {
            //doc.setCharacterAttributes(start, start, normal, false);
            return false;
        }
        /*if (Character.isWhitespace(character.charAt(0))) {
         return true;
    ...
    protected boolean isSpecial(String token) {
        return specials.contains(token);
    }
     ...
     *
     */
    protected String addMatchingBrace(int offset, String str) throws BadLocationException {
